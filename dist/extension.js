...
${doc.body}`),
    ...
    while ((m = literalOpenRe.exec(text)) !== null) {
      if (offset >= m.index && offset < m.index + 3) {
        return new vscode8.Hover(
          new vscode8.MarkdownString(`**${LITERAL_OPEN_DOC.title}**

${LITERAL_OPEN_DOC.body}`),
          new vscode8.Range(document.positionAt(m.index), document.positionAt(m.index + 3))
        );
      }
    }
    ...
    while ((m = literalCloseRe.exec(text)) !== null) {
      if (offset >= m.index && offset < m.index + 3) {
        return new vscode8.Hover(
          new vscode8.MarkdownString(`**${LITERAL_CLOSE_DOC.title}**
